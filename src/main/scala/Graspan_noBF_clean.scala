...
import utils.{Para,HBase_OP,deleteDir}

object Graspan_noBF_clean extends Para{
  ...
  def processGraph(graph_origin:RDD[(Int,Int,String)],input_grammar:String,symbol_Map:Map[String,EdgeLabel],
    ...
    val nodes_num_bitsize=HBase_OP.getIntBit(nodes_totoalnum)
...
//      htable_split_Map,htable_nodes_interval)
    HBase_OP.updateHbase_origin(graph,nodes_num_bitsize,symbol_num_bitsize,h_conf,h_job,h_table,hbase_output,
      htable_split_Map,htable_nodes_interval,"0")
    /**
      * 开始迭代
      */
...
//        htable_split_Map,htable_nodes_interval)
      HBase_OP.updateHbase_origin(newedges_removedup,nodes_num_bitsize,symbol_num_bitsize,h_conf,h_job,h_table,
        hbase_output,
        htable_split_Map,htable_nodes_interval,"0")
